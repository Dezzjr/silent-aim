...
Prefabs.BackgroundColor3 = Color3.new(10, 10, 10)
Prefabs.Size = UDim2.new(0, 100, 0, 100)
Prefabs.Visible = false
 
Label.Name = "Label"
Label.Parent = Prefabs
Label.BackgroundColor3 = Color3.new(10, 10, 10)
...
Window.Active = true
Window.BackgroundColor3 = Color3.new(10, 10, 10)
...
Resizer.Active = true
Resizer.BackgroundColor3 = Color3.new(10, 10, 10)
...
Toggle.Name = "Toggle"
Toggle.Parent = Bar
Toggle.BackgroundColor3 = Color3.new(10, 10, 10)
...
Top.Name = "Top"
Top.Parent = Bar
Top.BackgroundColor3 = Color3.new(10, 10, 10)
...
local Window = library:AddWindow("Christmas", {
...
CreditTAB:AddButton("Made by Christmas.#0001", function(bool)
    setclipboard("Christmas.#0001")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
...
pcall(function()
    game.StarterGui:SetCore("SendNotification", {
      ...
      Text = 'Join our discord, https://discord.gg/S4nPz6quZM';
      Duration = 40;
    })
